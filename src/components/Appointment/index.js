...
export default function Appointment(props) {
  ...
  const save = (name, interviewer, editBoolean) => {
    ...
    props
      .bookInterview(props.id, interview, editBoolean)
  ...
  return (
    <article className="appointment" data-testid="appointment">
      ...
      {mode === ERROR_SAVE && (
        <Error message={"Sorry, unable to save appointment"} onClose={back} />
      )}
      {mode === ERROR_DELETE && (
        <Error message={"Sorry, unable to delete appointment"} onClose={back} />
      )}
